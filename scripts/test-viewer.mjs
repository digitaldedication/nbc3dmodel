...
const config = {
  ...
  colors: { primary: '#F5A9C4', secondary: '#B9C6F2' },
  scene: 'congres',
  eventhall: { type: 'preset:geel', logoSpots: 2 },
  grandhall: { mode: 'kleur', colors: { primary: '#009684', secondary: '#5C2D91' } },
  pillarLogoPos: 'boven',
  hiddenTooltips: ['tooltip-grand-hall-podium', 'tooltip-hospitality1-ingang', 'tooltip-event-hall'],
